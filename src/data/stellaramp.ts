...
export function buildProgressSteps(variant: StateVariant): ReadonlyArray<ProgressStep> {
  return [
    { id: "s1", number: "01", title: variant.stepOneTitle, description: variant.stepOneDescription },
    { id: "s2", number: "02", title: variant.stepTwoTitle, description: variant.stepTwoDescription },
    { id: "s3", number: "03", title: "₦ PAYOUT", description: "Settlement to your local bank account." },
  ];
}
